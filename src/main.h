...
static const int64_t FORTUNA_COLLATERAL = (5000*COIN); // 5,000 ASTRO
static const int64_t FORTUNA_FEE = (0.010000*COIN); //0.01 ASTRO
static const int64_t POOL_FEE_AMOUNT = (0.1*COIN); //0.1 ASTRO
static const int64_t FORTUNA_POOL_MAX = (11000*COIN); //11,000 ASTRO
...
static const uint256 hashGenesisBlock("0x00000ded105913966a5a0a62c1de983ac2e58eaa9a3ac9dde7c2a4e1a1c17cd9");

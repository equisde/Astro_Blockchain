...
static void handleRunawayException(std::exception *e)
{
    ...
    QMessageBox::critical(0, "Runaway exception", BitcoinGUI::tr("A fatal error occurred. Astro can no longer continue safely and will quit.") + QString("\n\n") + QString::fromStdString(strMiscWarning));
    exit(1);
}
...
int main(int argc, char *argv[])
{
    ...
    if(GetBoolArg("-testnet")) // Separate UI settings for testnet
        app.setApplicationName("Astro-Qt-testnet");
    else
        app.setApplicationName("Astro-Qt");
    ...
    try
    {
        ...
        if(AppInit2())
        {
            ...
            splash.show();
            splashref = &splash;
            uiInterface.InitMessage(_("Astro is shutting down, please do not turn off your computer..."));

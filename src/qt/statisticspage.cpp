...
void StatisticsPage::updateStatistics()
{
	...
	int64_t marketcap = ASTROmarket.toDouble();
    ...
    {
        subsidy = "3 ASTRO per block";
    }
	else if (pindexBest->nHeight < 2000000)
    {
        subsidy = "4 ASTRO per block";
    }
	else if (pindexBest->nHeight < 3000000)
    {
        subsidy = "3 ASTRO per block";
    ...
    {
        ui->volumeBox->setText("<b><font color=\"yellow\">" + qVolume + " ASTRO" + "</font></b>");
    } else if(volume < volumePrevious) {
        ui->volumeBox->setText("<b><font color=\"red\">" + qVolume + " ASTRO" + "</font></b>");
    } else {
        ui->volumeBox->setText("<b><font color=\"orange\">" + qVolume + " ASTRO" + "</font></b>");
    }
